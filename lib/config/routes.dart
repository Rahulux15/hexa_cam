  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) =>
          FolderDetailPage(folderId: state.pathParameters['folderId']!),
    ),
    GoRoute(
      path: '/camera/:folderId',
      builder: (context, state) =>
          CameraPage(folderId: state.pathParameters['folderId']!),
    ),
    GoRoute(
      path: '/image/:folderId/:imageId',
    ...
    GoRoute(
      path: '/report/:folderId',
      builder: (context, state) => ReportPage(
        folderId: state.pathParameters['folderId']!,
        reportData: state.extra as Map<String, dynamic>?,
      ),
    ),
